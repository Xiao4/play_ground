...
function drawMap(mapPath, svg, c) {
	...
	d3.json(mapPath, function(error, root) {
		...
		svg.selectAll(".pathChina")
            ...
            .on("mouseout",function(d,i){
                ...
                clickChina(d, i, "/site/map/data/geometryProvince/" + id + ".json");
            });
	...
	// 		//$("#"+root.years[0]).click();
	// });
	circlemouseover("china", null, null, 2016);
...
function drawCoutyMap(d,svg) {
	...
	var mapPath = "/site/map/data/geometryCouties/" + id + "00.json";
	...
	d3.json(mapPath, function(error, root) {
		...
		svg.selectAll(".pathCouty")
            ...
            .on("mouseout",function(d,i){
                ...
                clickCouty(d, i, "/site/map/data/geometryProvince/" + id.substr(0,2) + ".json");
            });
		//获取中心点坐标
		root.features.forEach(function(d, i) {
			var centroid = path.centroid(d);
